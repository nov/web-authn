...
const register = (event) => {
  ...
  navigator.credentials.create(public_key_options).then(registered).catch(failed);
};
...
const authenticate = (event) => {
  ...
  navigator.credentials.get(public_key_options).then(authenticated).catch(failed);
};
